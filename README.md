...
In the realm of contemporary computer vision, 3D understanding stands as a pivotal yet formidable research frontier. The advent of deep learning has given rise to synthetic images generated by diffusion models, which are accompanied by pseudo 3D annotations. This development has introduced a novel data resource for 3D research. Nevertheless, around 25% of these synthetic images suffer from inconsistent viewpoints or shapes. As a result, the development of a dataset featuring accurate 3D annotations has become of utmost importance.<br>
The objective of this project is to establish such a dataset, which serves to assess the zero - shot/few - shot performance of 3D understanding models. These models are constructed leveraging the knowledge of existing large language models (LLMs) and generative diffusion models and are applied in tasks like object localization, detection, and segmentation. Through the meticulous annotation of object positions, rotations, and other attributes within the 3D space, this dataset can offer high - quality data support for related research endeavors. Consequently, it propels the application and advancement of 3D vision technology across diverse fields, including autonomous driving, vr, and robot perception. <br>
